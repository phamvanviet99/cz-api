package com.phamvanviet.demo.domain.config;
...
public class RedisCofig {
    ...
    @Bean
    public RedisTemplate<String, TokenInfo> tokenInfoRedisTemplate(RedisConnectionFactory redissonConnectionFactory) {
